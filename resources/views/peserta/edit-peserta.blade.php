                    ...
                    <div class="row">
                        <div class="col-8">
                            <div class="row">
                                ...
                                <div class="col-9">
                                <input type="text" name="nis" value="{{ $peserta->nis }}" class="form-control" placeholder="">
                                </div>
                            </div>
                            <br>
                            <div class="row">
                                ...
                                <div class="col-9">
                                <input type="text" name="nama_peserta" value="{{ $peserta->nama_peserta }}" class="form-control" placeholder="">
                                </div>
                            </div>
                            <br>
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-9">
                                <input type="text" name="semester_masuk" value="{{ $peserta->semester_masuk }}" class="form-control" placeholder="">
                                </div>
                            </div>
                            <br>
                            <div class="row">
