...
<div class="container">     
    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header text-primary">Buat Jadwal</div>
                    ...
                    <div class="row">
                        <div class="col-8">
                            ...
                            <div class="row">
                                ...
                                <div class="col-9">
                                <input type="text" name="level" value="{{ auth()->user()->pengajar->level }}" class="form-control" placeholder="" readonly>
                                </div>
                            </div>
                            <br>
                            <div class="row">
                                ...
                                <div class="col-9">
                                <input type="text" name="kode_pengajar" value="{{ auth()->user()->pengajar->kode_pengajar }}" class="form-control" placeholder="" readonly>
                                </div>
                            </div>
                            <br>
                            <div class="row">
                                ...
                                <div class="col-9">
                                <input type="text" name="nama_pengajar" value="{{ auth()->user()->pengajar->nama_pengajar }}" class="form-control" placeholder="" readonly>
                                </div>
                            </div>
                            <br>
                            <div class="row">
                                <label for="pengajar_id" class="col-3 col-form-label text-right"><strong>Id Pengajar :</strong></label>
                                <div class="col-9">
                                <input type="text" name="pengajar_id" value="{{ auth()->user()->pengajar->id }}" class="form-control" placeholder="" readonly>
                                </div>
                            </div>
                            <br>
                            <div class="row">
