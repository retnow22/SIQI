        ...
        <div class="container">     
            <div class="row justify-content-center">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                        <form action="{{ route('regis-peserta.store') }}" method="POST">
                            @csrf
                        
                            <div class="row">
                                <div class="col-12">
                                    <div class="row">
                                        <label for="nama_peserta" class="col-2 col-form-label text-right"><strong>Nama :</strong></label>
                                        <div class="col-10">
                                    ...
                                    <br>
                                    <div class="row">
                                        <label for="semester_masuk" class="col-2 col-form-label text-right"><strong>Semester :</strong></label>
                                        <div class="col-10">
