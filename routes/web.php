...
Route::get('/profil-pengajar', 'PengajarController@profil')->name('pengajar.profil');
...
Route::put('/profil-pengajar/{id}', 'PengajarController@updateprofil')->name('pengajar.updateprofil');
Route::patch('/profil-pengajar/{id}', 'PengajarController@updateprofil')->name('pengajar.updateprofil');
Route::get('/profil-peserta', 'PesertaController@profil')->name('peserta.profil');
Route::put('/profil-peserta/{id}', 'PesertaController@updateprofil')->name('peserta.updateprofil');
Route::patch('/profil-peserta/{id}', 'PesertaController@updateprofil')->name('peserta.updateprofil');